...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube_2()
    volume_of_cube_2 = volume_of_cube( 2 )
    assert_equal( 8, volume_of_cube_2 )
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_of_sphere_3 =  volume_of_sphere( 3 )
    assert_equal(113, volume_of_sphere_3 )
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_to_celsius_32 = fahrenheit_to_celsius( 32 )
    assert_equal( 0, fahrenheit_to_celsius_32 )
  end
